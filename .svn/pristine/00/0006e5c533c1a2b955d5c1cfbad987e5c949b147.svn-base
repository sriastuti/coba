...
<script type='text/javascript'>
	...
	function download(){	
		...
		swal({
		  title: "Download?",
		  text: "Download Laporan Diagnosa Pasien Keluar Rawat Inap!",
		  type: "warning",
		...
		function(isConfirm){
		  if (isConfirm) {
			...
			window.open("<?php echo base_url('medrec/medclaporan/download_diag_ri2')?>/"+startDate+"/"+endDate+"/"+lokasi+"/"+kelas);
		  } else {
		...
		<div class="card card-outline-info" style="width:97%;margin:0 auto">
			...
			<div class="card-block">
				<div class="row">
					...
					<div class="form-group">						
								<select  class="form-control select2" name="lokasi" id="lokasi" onchange="" >
					...
					<div class="form-group">
						<select  class="form-control" name="klsiri" id="klsiri" onchange="" disabled="">
