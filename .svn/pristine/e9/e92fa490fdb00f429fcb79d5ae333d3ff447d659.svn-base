					...
					<div class="panel-body">
						...
						<div id="myTabContent" class="tab-content">
							...
							<div class="tab-pane fade"  id="pane_cari_poli">
								<div class="row">
								<div class="form-inline">
									<?php echo form_open('irj/Rjclaporan/data_kunjungan_poli');?>
									<div class="col-lg-10">
										<div class="form-inline">
											...
											<input type="search" style="width:430;"class="auto_search_poli form-control" id="nm_poli" name="nm_poli" placeholder="Nama Poli" required>
