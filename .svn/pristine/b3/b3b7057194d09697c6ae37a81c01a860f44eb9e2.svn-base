				...
				<div class="box">
					...
					<div class="box-body">
						<table id="example" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
							...
							<tbody>
								<?php
									...
									$i=1;
										foreach($get_data_edit_tindakan_pa as $row){
								?>
								<tr>
								  	<td><?php echo $i;?>
									...
									<td>
								  	<input type="text" class="form-control" name="hasil_pa_<?php echo $i;?>" value="<?php echo $row->hasil_pa;?>">
								  	</td>
						...
						<div class="form-inline" align="right">
							...
							<input type="hidden" class="form-control" value="<?php echo $no_pa;?>" name="no_pa"><br>
