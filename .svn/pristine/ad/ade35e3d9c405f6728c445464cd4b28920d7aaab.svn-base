			...
			<div class="box">
				...
				<div class="box-body">
					<div class="form-group row">
						<!-- <div class="col-md-3">
							<?php echo form_open('faktur/fcrekap/pa');?>
					...
					<table id="example" class="display" cellspacing="0" width="100%">
						...
						?>
							<tr>
							  ...
							  <td>
									<a href="<?php echo site_url('pa/pacdaftar/cetak_faktur_by_noreg/'.$no_register); ?>" target="_blank"class="btn bg-orange btn-sm" style="width:63px; margin:2px;">Faktur</a>
							  </td>
							</tr>
						<?php
							}
