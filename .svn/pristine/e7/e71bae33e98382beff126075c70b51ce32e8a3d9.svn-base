...
<div class="content-wrapper">
	...
	<?php
		include('rjvlapkunjpencarian.php');
	?>
		</section>
					...
					<div class="panel-body">
						...
						?>
							<tr>
								...
								<td><p align="right"><?php echo $row->jumlah_kunj;?></p></td>
							</tr>
						<?php
							}
						?>
							<tr>
								...
								<td><p align="right"><b><?php echo $vtot;?></b></p></td>
							</tr>
							  </tbody>
							 </table>
							<div class="form-inline" align="right">
								<div class="form-group">
									<a target="_blank" href="<?php echo site_url('irj/Rjclaporan/lap_kunj_poli/'.$date.'/'.$tampil_per.'/'.$id_poli);?>"><input type="button" class="btn btn-primary" value="Cetak"></a>
								</div>
							</div>
						</div>
					</div><!--- end panel body --->
