...
<?php
include('Frmvdetailpembelian_bhp.php');
?>
    ...
    <div class="panel panel-info">
     ...
     <?php echo form_open('logistik_farmasi/Frmcpembelian/insert_pembelian'); ?>
								...
								<div class="form-group row">
									...
									<div class="col-sm-4">
										<select id="satuank" class="form-control js-example-basic-single" name="satuank" required>
							...
							<div class="form-inline" align="right">
								...
								<input type="hidden" class="form-control" value="BHP" name="jenis">
								...
								<?php
									...
									?>
										<tr>
											...
											<td><a href="<?php echo site_url("logistik_farmasi/Frmcpembelian/hapus_data_receiving/".$row->id_receivings_item."/".$row->item_id."/".$no_faktur."/BHP");?>" class="btn btn-danger btn-xs">Hapus</a></td>
