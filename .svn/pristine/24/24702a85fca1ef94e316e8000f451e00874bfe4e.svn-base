...
<script type='text/javascript'>
	...
	function download(){	
		...
		if(poli == null){
			...
			swal("Gagal", "Pilih Poliklinik Terlebih Dahulu", "error");
		}else{
			swal({
			  title: "Download?",
			  text: "Download Sensus Harian Rawat Jalan!",
			  type: "warning",
			...
			function(isConfirm){
			  if (isConfirm) {
				...
				window.open("<?php echo base_url('medrec/medclaporan/download_sensus_rj')?>/"+tgl_sensus+"/"+poli);
			  } else {
		...
		<div class="card card-outline-info" style="width:97%;margin:0 auto">
			...
			<div class="card-block">
				<!-- <div class="row"> -->
					...
					<div class="form-group">
						<select  class="form-control select2" name="poli" id="poli" required="">
