...
<script type='text/javascript'>
	...
	function download(){	
		...
		swal({
		  title: "Download?",
		  text: "Download Laporan Tindakan Rawat Jalan RS !",
		  type: "warning",
		...
		function(isConfirm){
		  if (isConfirm) {
			...
			window.open("<?php echo base_url('medrec/medclaporan/download_chart_rj')?>/"+startDate+"/"+endDate+"/"+lokasi);
		  } else {
		...
		<div class="card" style="width:97%;margin:0 auto">
			...
			<div class="card-block">
				<div class="row">
						...
						<div class="col-lg-4">
							<select  class="form-control" name="poli" id="poli" onchange="" >
