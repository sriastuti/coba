...
<div class="row">
    <div class="col-md-12">
        <div class="card card-block printableArea">
            <h3><b>INVOICE</b> <span class="pull-right">#<?php echo $no_pa; ?></span></h3>
            <hr>
            <div class="row">
                <div class="col-md-12">
                            ...
                            <tbody>
								...
								?>
									<tr>
	                                    ...
	                                    <td class="text-right"> <?php echo number_format( $row->biaya_pa, 2 , ',' , '.' ); ?> </td>
                ...
                <div class="col-md-12">
                    ...
                    <hr>
					<?php
						echo form_open('pa/packwitansi/st_cetak_kwitansi_kt');
					?>
                    <div class="text-right">
						<div class="input-group">
					...
					<input type="hidden" class="form-control" name="no_pa" value="<?php echo $no_pa ?>">
