...
function cek_tgl(tgl){		
	...
	function cek_tampil_per(val_tampil_per){
		...
		if(val_tampil_per=='TGL'){			
			...
			document.getElementById("date_picker_days0").required = true;
			document.getElementById("date_picker_days1").required = true;
			...
			document.getElementById("date_picker_days").value = '';
			document.getElementById("date_picker_years").value = '';
			document.getElementById("date_picker_days0").required = false;
			document.getElementById("date_picker_days1").required = false;
