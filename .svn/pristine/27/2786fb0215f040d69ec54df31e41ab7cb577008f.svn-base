...
<?php $this->load->view("iri/ubah_cara_bayar"); ?>
<script>
										...
										<div class="box-body">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													...
													<select class="form-control input-sm" name="carabayar" onchange="update_form_bpjs(this.value)">
														<?php
									...
									<div class="col-sm-6 form-right">
										<div class="box-body">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control input-sm" id="calendar-tgl-lahir" name="tgllahirri" value="<?php echo $data_pasien[0]['tgl_lahir']; ?>" disabled="true">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="box box-success">
													...
													<div class="box-body ">
														...
														<div class="form-group form_bpjs">
															...
															<div class="col-sm-9" align="left">
																<input type="text" class="form-control input-sm" name="nosjp" value="<?php echo $data_pasien[0]['no_rujukan']; ?>" id="nosjp">
															</div>
														</div>
													<!-- 	<div class="form-group">
														...
														<div class="form-group form_bpjs">
															...
															<div class="col-sm-9" align="left">
																<input type="text" class="form-control input-sm" name="no_bpjs" id="no_bpjs" value="<?php echo $data_pasien[0]['no_kartu']; ?>" disabled="true">
												...
												<div class="box-body">
													...
													<div class="form-group">
														...
														<div class="col-sm-9" align="left">
															...
															<select class="form-control input-sm" name="jatahkls">
																<?php
