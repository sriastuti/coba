...
<section class="content-header">
	...
	<div class="card" style="background: #e4efe0">
		<div class="inner">
			<div class="container-fluid text-center"><br/>
				<div class="form-inline">
					<?php echo form_open('medrec/el_record');?>
					...
					<button type="submit" class="btn btn-primary" type="button"><i class="fa fa-search"></i> Cari</button>
			...
			<div class="col-sm-12">
				<div class="card card-outline-default">
					<div class="card-block">
						<br>
						<table id="example" class="display nowrap table table-hover" cellspacing="0" width="100%">
							<thead>
								<tr>
									<th>No Medrec</th>
									<th>No Identitas</th>
