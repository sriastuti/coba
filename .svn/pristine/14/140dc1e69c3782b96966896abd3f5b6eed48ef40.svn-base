...
<?php $this->load->view("iri/log_data_pasien_keluar"); ?>
									...
									if(!empty($list_tindakan_pasien)){
										...
										<tr>
											...
											$tgl_indo = $controller->obj_tanggal();
									  		...
									  		$bln_row = $tgl_indo->bulan(substr($r['tgl_layanan'],6,2));
									  		$tgl_row = substr($r['tgl_layanan'],8,2);
									  		$thn_row = substr($r['tgl_layanan'],0,4);
