...
<script type='text/javascript'>
	...
	function download(){	
		...
		swal({
		  title: "Download?",
		  text: "Download Laporan Kunjungan Kamar Operasi!",
		  type: "warning",
		...
		function(isConfirm){
		 ...
		 //    $.ajax({
			// 	type:'POST',
			// 	dataType: 'json',
			// 	url:"<?php echo base_url('ok/okclaporan/download_kunjungan')?>",
			// 	data: {
		 ...
		 //    swal("Download", "Sukses", "success");
			...
			// });
			swal("Download", "Sukses", "success");
			window.open("<?php echo base_url('ok/okclaporan/download_kunjungan')?>/"+startDate+"/"+endDate);
		  } else {
	...
	<div class="row">
		<div class="card card-outline-success" style="width:97%;margin:0 auto">
			<div class="card-header">		
				<h4  align="center" class="text-white">Laporan Keuangan Kamar Operasi</h4>
			</div>
