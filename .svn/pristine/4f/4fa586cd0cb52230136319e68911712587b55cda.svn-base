...
<script type='text/javascript'>
	...
	function download(){	
		...
		swal({
		  title: "Download?",
		  text: "Download Laporan Diagnosa Rawat Darurat!",
		  type: "warning",
		...
		function(isConfirm){
		  if (isConfirm) {
			...
			window.open("<?php echo base_url('medrec/medclaporan/download_diag_rd2')?>/"+startDate+"/"+endDate);
		  } else {
				        	...
				        	<div class="input-group">
				          	<div class="input-group-addon">
				            	<i class="fa fa-calendar"></i>
				          		...
				          		<input type="text" class="form-control pull-right input-daterange-datepicker" id="tanggal_laporan" name="tanggal_laporan">&nbsp;
				        	</div>
				        	<!-- /.input group -->			
					</div>
						<div class="form-group">
