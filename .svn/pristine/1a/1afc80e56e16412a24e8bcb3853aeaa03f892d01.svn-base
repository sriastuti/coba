<div class="row">
	<div class="form-group">
		<?php echo form_open('iri/rilaporan/');?>
		...
		<div id="date_input" >
			<div class="col-lg-2">
				<input type="text" id="date_picker_days0" class="form-control" placeholder="Tanggal Awal" name="date_picker_days0" required onchange="cek_tgl(this.value)">
			</div>
			<div class="col-lg-2">
				<input type="text" id="date_picker_days1" class="form-control" placeholder="Tanggal Akhir" name="date_picker_days1" required onchange="cek_tgl(this.value)">
			</div>
		</div>
		<div id="month_input">
			<div class="col-lg-2">
		...
		<div class="col-lg-1">
			<span class="input-group-btn">
				<button class="btn btn-primary" name="btnSubmit" id="btnSubmit" type="submit">Download</button>
			</span>
		</div>
