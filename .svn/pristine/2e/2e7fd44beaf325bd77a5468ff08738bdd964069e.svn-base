	...
	<!-- table -->
		<br>
			<div style="display:block;overflow:auto;">
				...
				<table id="tabel_tindakan" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>No</th>
							<th>Total</th>
				...
				<table id="tabel_cetak_rad" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>No</th>
							<th>Total</th>
