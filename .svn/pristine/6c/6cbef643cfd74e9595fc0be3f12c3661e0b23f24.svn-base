...
where a.bayar=0 and (a.bpjs=0 or a.bpjs is null) and a.xcetak is null and LEFT(b.tgl_kunjungan,10)='$date' and a.no_register=b.no_register and b.xcetak is null group by a.no_register ORDER BY b.cara_bayar desc");
		}
		/////////////////////////////////////////////////////////////////////////////////////kwitansi tindakan
