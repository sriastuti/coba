<?php
	...
	class SEP extends FPDF {
		...
		public function cetak() {
			...
			$this->SetTitle("SEP_".$this->fields_value['No. Register'].".pdf");
		...
		private function header_surat() {
			...
			$this->Cell(1);
			$this->Cell(10, 15, $this->Image(getenv('DOCUMENT_ROOT'). '/hmis_muara/asset/images/logos/logobpjs.png',$this->GetX(), $this->GetY(),	 45), 0, 0);
