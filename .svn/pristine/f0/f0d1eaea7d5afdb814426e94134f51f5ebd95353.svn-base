   ...
   console.log(count);
	...
	<div class="container-fluid">
		...
		<section class="content">
			<div class="row">
				<div class="card card-outline-info">
					<div class="card-header" align="center"><h3 class="text-white">Rincian Biaya - Nomor Kwitansi <?php echo $data_pasien->id_loket.$data_pasien->no_kwitansi;?></h3></div>
							...
							<table class="table">
							  <tbody>
								...
								<tr>
									<th>User Cetak</th>
									<td>:</td>
									<td><?php echo strtoupper($data_pasien->user_cetak);?></td>
									<th>Tgl Cetak</th>
									<td>:</td>
									<td><?php echo date('d-m-Y H:i',strtotime($data_pasien->xcreate));?></td>
								</tr>	
			</tr>
			<tr>
			...
			<?php }?>
						...
						<hr>
						<h4 align="center"><b>BATAL KWITANSI RAWAT JALAN</b></h4>
						<hr>
		...
		<tbody>
			...
			<tr>
				<th style="width:20%;">Catatan Perubahan</th>
				<td>:</td>
				<td colspan="2" style="width:40%;">
					<div class="input-group">
						<span class="input-group-addon"></span>
							<input type="text" class="form-control" name="note_retur" id="note_retur" placeholder="Catatan Alasan Pembatalan" required>							
						<span class="input-group-btn">
						<button type="btn" class="btn btn-primary" onclick="setBatal()">Input</button>
					</span>
					</div>
	...
	<br>
		<div class="form-inline row" align="left" style="margin-left:10px;">
			<div class="input-group">				
			<?php echo form_open('irj/rjckwitansi/st_cetak_kwitansi_batal_kt');?>
					<input type="hidden" class="form-control" name="total_hide" id="total_hide">
					<input type="hidden" class="form-control" value="<?php echo sizeof($data_tindakan);?>" name="tot_tind_hide" id="tot_tind_hide">
					<input type="hidden" class="form-control" value="<?php echo $data_pasien->idno_kwitansi;?>" name="id_kwitansi_old_hide" id="id_kwitansi_old_hide">
