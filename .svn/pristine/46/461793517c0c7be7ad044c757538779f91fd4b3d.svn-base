				...
				<form id="form_search" onSubmit="return false;">
	                <div class="row p-t-10 m-b-15">
	                    ...
	                    <div class="col-md-4">
							...
							<select name="search_jenis" id="search_jenis" class="form-control" style="width:250;">
								<option value="1">ANGGOTA MILITER</option>
								<option value="2">PNS</option>
								<option value="3">PHL</option>									
							</select>	                        
							<input type="text" class="form-control date_picker" id="search_tgl_lahir" name="search_tgl_lahir">
	                    </div>	                        
	                    <div class="col-md-6">
	                        <div class="form-actions">	
	                        	<button class="btn waves-effect waves-light btn-primary" type="button" id="btn-search" style="margin-right: 10px;">
	                        		<i class="fa fa-search"></i> Cari Data Personil
	                        	</button>                        	
