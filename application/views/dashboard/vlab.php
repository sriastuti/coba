          ...
          <div class="card-body">
            <div class="col-md-12">
              <div class="d-flex flex-wrap">                
                  <h4 class="card-title"><br><b>Laboratorium</b></h4>
            ...
            <div class="col-md-12">
              <div class="form-inline">
                <div class="form-group">
                  ...
                  <button class="btn btn-primary btn-xs" type="submit" onclick="pilih_lab()"><i class="fa fa-search"></i> Cari</button><br><br>
                </div>
              </div>
            </div>
            <div class="col-md-12">
                ...
                <table class="display nowrap table table-hover table-bordered dataTable" id="example" style="font-size: 14px; border: 2px solid black;" >
                    <thead style="border: 2px solid black; font-weight: bold;">
                        <tr style="border: 2px solid black;">
                            ...
                            <td style="border: 2px solid black; vertical-align: middle;"><center>NO LAB</center></td>
  ...
  function pilih_lab() {
    ...
    if(tgl_awal!="" && tgl_akhir!=""){
      ...
      objTable = $('#example').DataTable( {
        ajax: "<?php echo site_url('dashboard/kunj_lab'); ?>/"+tgl_awal+"/"+tgl_akhir,
        columns: [
          { data: "rank" },
          { data: "no_lab" },
          { data: "no_register" },
