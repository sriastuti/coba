					...
					<tr>
						...
						?>
							<tr>
								...
								<td><?php echo strtoupper($row->carabayar);?></td>
						...
						?>
							...
							<div class="form-inline" align="right">
								<div class="form-group">
									<a id="btnDown" name="btnDown" class="btn btn-primary" target="_blank" href="<?php echo site_url('iri/rilaporan/export_excel/'.$tampil_per.''.$status.'/'.$tgl);?>" >Download Excel</a>
									<a id="btnCetak" name="btnCetak" class="btn btn-primary" target="_blank" href="<?php echo site_url('iri/rilaporan/lap_keu/'.$tampil_per.''.$status.'/'.$tgl);?>">Cetak</a>
								</div>
							</div>
