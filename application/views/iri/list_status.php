					...
					<div class="card">
						...
						<div class="tab-content">
							...
							<div class="tab-pane" id="tindakan" role="tabpanel">
								<div class="p-20">
								<table  class="table table-hover table-striped table-bordered data-table" id="dataTables-example2" style="width:100%;" style="table-layout: fixed;">
								  <thead>
									<tr>
									  <th>Tindakan</th>
									  <th>Pelaksana</th>
								  ...
								  <tbody>
									...
									if(!empty($list_tindakan_pasien)){
										...
										<tr>
											...
											<td>
											<?php if($access=='1' && $state==''){ ?>
												<a href="<?php echo base_url(); ?>iri/rictindakan/hapus_tindakan/<?php echo $r['id_jns_layanan'] ;?>/<?php echo $data_pasien[0]['no_ipd'];?>" class="btn btn-danger btn-xs">Hapus</a>
												<?php } ?>
											</td>
										</tr>
										<?php
							...
							<div class="tab-pane" id="lab_pasien" role="tabpanel">
								...
								<table class="table table-hover table-striped table-bordered data-table" id="dataTables-example4" style="width:100%;" style="table-layout: fixed;">
								  <thead>
									<tr>
									  <th>No Lab</th>
							...
							<div class="tab-pane" id="pa_pasien" role="tabpanel">
								...
								<table  class="table table-hover table-striped table-bordered data-table" id="dataTables-example5" style="width:100%;" style="table-layout: fixed;">
								  <thead>
									<tr>
									  <th>No PA</th>
									  <th>Jenis Tindakan</th>
								...
								<div class="form-inline" align="right">
									<div class="input-group">
										<table width="100%" class="table table-hover table-striped table-bordered" style="table-layout: fixed;">
											<tr>
							...
							<div class="tab-pane" id="radiologi" role="tabpanel">
								...
								<div class="form-inline" align="right">
									<div class="input-group">
										<table width="100%" class="table table-hover table-striped table-bordered data-table" style="table-layout: fixed;">
											<tr>
							...
							<div class="tab-pane" id="resep_pasien" role="tabpanel">
								...
								<?php if($state==''){?>
                                    <button class="btn btn-primary btn-sm" onclick="inputResep()"><i class="fa fa-plus"></i> Resep</button>&nbsp;&nbsp;
                                <?php } else {} ?>
								</div>
							</div>
