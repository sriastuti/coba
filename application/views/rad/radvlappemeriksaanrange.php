...
function down_excel(){
    ...
    if(date0=='' && date1==''){
    	...
    	window.open('<?php echo site_url('rad/Radclaporan/excel_lappemeriksaan');?>/'+date0+"/"+date1, '_blank');    
    }
}
...
<section class="content">
	<div class="row">
		<div class="card card-block" style="width:97%;margin:0 auto">
			<div class="card-title">	Laporan Pemeriksaan Radiologi				
			</div>
			<div class="">				
				<table id="laprad" class="display" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>No</th>
							<th>Nama Tindakan</th>
