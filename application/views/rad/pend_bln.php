...
<div class="form-inline" align="right">
	<div class="form-group">
		<a id="btnExcel" name="btnExcel" class="btn btn-primary" href="<?php echo site_url('rad/Radclaporan/export_excel/'.$tampil_per.'/'.$bln.'/'.$jenis_bayar);?>">Download Excel</a>
		<a target="_blank" id="btnCetak" name="btnCetak" class="btn btn-primary" href="<?php echo site_url('rad/Radclaporan/lap_keu/'.$tampil_per.'/'.$bln.'/'.$jenis_bayar);?>">Cetak</a>
	</div>
</div>
<?php	} else {
	echo $message_nodata;
