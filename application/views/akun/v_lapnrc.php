...
<section class="content-header">
	<div class="form-group row">
		<div class="form-inline">
			<?php echo form_open('akun/Crsnrl/lap_neraca');?>
			<div id="date_input">
				<div class="col-lg-4">
	...
	<div class="row">
		<div class="card card-outline-info" style="width:97%;margin:0 auto">
			...
			<div class="card-block">				
				<?php
	if(count($data_lap_neraca)>1){
?>
<table id="example" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
	<thead>
		<tr>
			<th>No</th>
			<th width='5%'>Param 1</th>
			<th>Param 2</th>
			<th>Param 3</th>		
	...
	<tbody>
		...
		$i=1;
		$vtot_banyak=0;
		foreach($data_lap_neraca as $row){
		...
		<tr>
			...
			<?php foreach($data_detail_lap_neraca as $row1){
...
<div class="pull-right">
	<a href="<?php echo site_url('akun/crsnrl/cetak_lap_pdf/'.$tampil_per.'/'.$date0); ?>" target="_blank" class="btn btn-primary">Cetak</a>&nbsp;&nbsp;&nbsp;<a href="<?php echo site_url('akun/crsnrl/cetak_lap_excel/'.$tampil_per.'/'.$date0); ?>" target="_blank" class="btn btn-primary">Excel</a>
</div>
