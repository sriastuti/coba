...
<div class="form-inline" align="right">
	<div class="form-group">
		<a id="btnExcel" name="btnExcel" class="btn btn-primary" href="<?php echo site_url('logistik_farmasi/Frmclaporan/export_excel/'.$tampil_per.'/'.$thn);?>">Download Excel</a>
		<a target="_blank" id="btnCetak" name="btnCetak" class="btn btn-primary" href="<?php echo site_url('logistik_farmasi/Frmclaporan/lap_keu/'.$tampil_per.'/'.$thn);?>">Cetak PDF</a>
	</div>
</div>
<?php	} else {
	echo $message_nodata;
