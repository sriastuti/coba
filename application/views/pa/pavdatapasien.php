							...
							<div class="col-sm-10">
								<table class="table-sm table-striped" style="font-size:15" width="100%">
									...
									?>
										...
										<?php if($pemeriksaan_kee=='' || $pemeriksaan_kee=='0') { ?>
										<tr>
											<th>Status</th>
											<td>:&nbsp;</td>
											<td>Pasien Luar / Pasien Baru Pemeriksaan</td>
										</tr>
										<?php } else { ?>
										<tr>
											<th>Sudah pernah pemeriksaan sebanyak</th>
											<td>:&nbsp;</td>
											<td><?php echo $pemeriksaan_kee;?> kali</td>
										</tr>
