...
setInterval(intervalSetting, 120000);
	...
	<section class="content" style="width:97%;margin:0 auto">
		<div class="row">			
			...
			<div class="box">
					<div class="box-title">
						<center><h4> Daftar Pasien IRD belum Pulang Tanggal <b><?php echo date('d-m-Y', strtotime("-6 days")) ?></b> s/d <b><?php echo  date('d-m-Y') ?></b></h4><hr></div>
					<div class="box-body">
						
						<table id="tableBelumPulang"  class="display" cellspacing="0" width="100%">
							<thead>
								<tr>
								  <th>No</th>
								  <th>No Medrec</th>
							  ...
							  <tbody><?php //if($search_per=='nama' || $search_per=='alamat') { ?>
								...
								?>
									<tr>
										...
										<td>
											<a href="<?php echo site_url("ird/irDPelayanan/pelayanan_pasien/".$no_register);?>" class="btn btn-danger btn-xs">Tindak</a>
										</td>
									</tr>
								<?php
									}}
