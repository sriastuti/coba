						...
						?>
							...
							<div class="form-inline" align="right">
								<div class="form-group">
									<a target="_blank" id="btnDown" name="btnDown" class="btn btn-primary" href="<?php echo site_url('ird/IrDLaporan/export_excel/'.$tampil_per.''.$status.'/'.$thn.'/'.$psn);?>">Download Excel</a>
									<a target="_blank" id="btnCetak" name="btnCetak" class="btn btn-primary" href="<?php echo site_url('ird/IrDLaporan/lap_keu/'.$tampil_per.''.$status.'/'.$thn.'/'.$psn);?>">Cetak PDF</a>
								</div>
							</div>
